...
const AlertComponentForInformation = (props: any) => {
    ...
    return (
        <Modal
            ...
            transparent={true}
        >
            <TouchableOpacity onPress={cancelAlert} style={{ height: HEIGHT * 1, width: WIDTH * 1, backgroundColor: 'rgba(0,0,0,0.3)', justifyContent: 'center', borderRadius: 20, zIndex: 8, alignItems: 'center' }}>
                <Animatable.View duration={500} animation='zoomIn' style={[styles.textModal, { height: 'auto', borderRadius: 20,zIndex:999 }]}>
                    <View style={{ height: 'auto', justifyContent: 'center', borderTopLeftRadius: 20, borderTopRightRadius: 20, borderRadius: 20 }}>
