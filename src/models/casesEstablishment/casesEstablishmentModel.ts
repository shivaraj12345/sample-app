...
export type establishmentStoreModel = Instance<typeof CasesEstablishmentStore>
...
const CasesEstablishmentStore = types.model('CasesEstablishmentModel', {
...
export default CasesEstablishmentStore;
