...
export type contactStoreModel = Instance<typeof ScheduledRoutlineInspectionStore>
...
const ScheduledRoutlineInspectionStore = types.model('ScheduledRoutlineInspectionModel', {
    result: types.string,
    ...
    setScheduledRoutlineInspectionDataBlank() {
        self.result='',
        self.finalComments = '',
        self.contactName='',
        self.mobileNumber='',
...
export default ScheduledRoutlineInspectionStore;
