...
export type establishmentStoreModel = Instance<typeof AboutHistoryEstablishmentStore>
...
const AboutHistoryEstablishmentStore = types.model('AboutHistoryEstablishmentModel', {
    ...
    setAboutHistoryEstablishmentDataBlank() {
...
export default AboutHistoryEstablishmentStore;
