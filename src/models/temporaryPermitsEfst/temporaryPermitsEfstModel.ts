...
export type contactStoreModel = Instance<typeof TemporaryPermitsEfstStore>
...
const TemporaryPermitsEfstStore = types.model('TemporaryPermitsEfstModel', {
    ...
    setTemporaryPermitsEfstDataBlank() {
        self.foodHandlerId = '',
        self.emiratesId = '',
...
export default TemporaryPermitsEfstStore;
