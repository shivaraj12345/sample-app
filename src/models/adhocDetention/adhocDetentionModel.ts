...
export type detentionStoreModel = Instance<typeof AdhocDetentionStore>
...
const AdhocDetentionStore = types.model('AdhocDetentionModel', {
...
export default AdhocDetentionStore;
