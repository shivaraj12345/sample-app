...
export type adhocTaskEstablishmentListStoreModel = Instance<typeof AdhocTaskEstablishmentListStore>
...
const AdhocTaskEstablishmentListStore = types.model('AdhocTaskEstablishmentListModel', {
...
export default AdhocTaskEstablishmentListStore;
