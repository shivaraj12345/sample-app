...
export type inspectionStoreModel = Instance<typeof LicenseInspectionStore>
...
const LicenseInspectionStore = types.model('LicenseInspectionModel', {
    taskId: types.number,
...
export default  LicenseInspectionStore;
