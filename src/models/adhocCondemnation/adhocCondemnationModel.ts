...
export type condemnationStoreModel = Instance<typeof AdhocCondemnationStore>
...
const AdhocCondemnationStore = types.model('AdhocCondemnationModel', {
...
export default AdhocCondemnationStore;
