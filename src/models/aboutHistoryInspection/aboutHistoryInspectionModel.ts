...
export type inspectionStoreModel = Instance<typeof AboutHistoryInspectionStore>
...
const AboutHistoryInspectionStore = types.model('AboutHistoryInspectionModel', {
    taskId: types.number,
    ...
    setAboutHistoryInspectionDataBlank() {
        self.taskId = 0,
        self.taskType = '',
        self.creationDate = '',
...
export default AboutHistoryInspectionStore;
