...
export type establishmentStoreModel = Instance<typeof  CompletdMyTaskEstablishmentStore>
...
const CompletdMyTaskEstablishmentStore = types.model('CompletdMyTaskEstablishmentModel', {
...
export default  CompletdMyTaskEstablishmentStore;
