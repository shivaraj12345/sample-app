...
export type contactStoreModel = Instance<typeof TemporaryPermitsContactStore>
...
const TemporaryPermitsContactStore = types.model('TemporaryPermitsContactModel', {
    type: types.string,
    name: types.string,
    ...
    setTemporaryPermitsContactDataBlank() {
        self.type = '',
        self.name = '',
        self.nationality = '',
        self.mobileNumber = '',
...
export default TemporaryPermitsContactStore;
