...
export type contactStoreModel = Instance<typeof  ReminderMyTaskStore>
...
const  ReminderMyTaskStore = types.model('ReminderMyTaskModel', {
...
export default ReminderMyTaskStore;
