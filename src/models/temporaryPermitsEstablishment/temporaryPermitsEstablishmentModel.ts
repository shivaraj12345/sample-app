...
export type establishmentStoreModel = Instance<typeof  TemporaryPermitsEstablishmentStore>
...
const TemporaryPermitsEstablishmentStore = types.model('TemporaryPermitsEstablishmentModel', {
    ...
    setTemporaryPermitsEstablishmentDataBlank() {
...
export default  TemporaryPermitsEstablishmentStore;
