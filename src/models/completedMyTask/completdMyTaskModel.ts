...
export type contactStoreModel = Instance<typeof CompletdMyTaskStore>
...
const CompletdMyTaskStore = types.model('CompletdMyTaskModel', {
    completedTaskArray: types.string,
    ...
    setCompletedTaskArray(arr: any) {
        self.completedTaskArray = arr;
    },
    setCompletedMyTakDataBlank() {
        self.inspection = '',
            self.type = '',
            self.status = '',
            self.date = '',
...
export default CompletdMyTaskStore;
