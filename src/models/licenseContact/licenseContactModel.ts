...
export type contactStoreModel = Instance<typeof LicenseContactStore>
...
const LicenseContactStore = types.model('LicenseContactModel', {
    type: types.string,
    name: types.string,
...
export default LicenseContactStore;
