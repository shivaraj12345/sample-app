...
export type contactStoreModel = Instance<typeof CompletedTaskContactStore>
...
const CompletedTaskContactStore = types.model('CompletedTaskContactModel', {
    type: types.string,
    name: types.string,
...
export default CompletedTaskContactStore;
