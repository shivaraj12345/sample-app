...
export type samplingStoreModel = Instance<typeof CasesSamplingStore>
...
const CasesSamplingStore = types.model('CasesSamplingModel', {
...
export default CasesSamplingStore;
