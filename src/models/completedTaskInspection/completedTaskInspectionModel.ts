...
export type inspectionStoreModel = Instance<typeof CompletedTaskInspectionStore>
...
const CompletedTaskInspectionStore = types.model('CompletedTaskInspectionModel', {
    taskId: types.number,
...
export default CompletedTaskInspectionStore;
