...
export type contactStoreModel = Instance<typeof   TemporaryPermitsMyTaskStore>
...
const  TemporaryPermitsMyTaskStore = types.model('TemporaryPermitsMyTaskModel', {
...
export default TemporaryPermitsMyTaskStore;
